...
**Desired state**: what you declared, whether a Terraform Cloud workspace, a raw
...
**Integration**: a connected source, whether a state source, a cross-check credential,
